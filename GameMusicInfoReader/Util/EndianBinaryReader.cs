...
namespace GameMusicInfoReader.Util
{
	...
	public sealed class EndianBinaryReader : BinaryReader
	{
		...
		/// <param name="endian">The <see cref="Endian"/> to use when reading files.</param>
		public EndianBinaryReader(Stream stream, Encoding encoding, Endian endian)
		...
		public EndianBinaryReader(Stream stream, Encoding encoding, bool leaveOpen, Endian endian)
